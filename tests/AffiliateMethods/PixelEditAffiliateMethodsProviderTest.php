...
/**
 * Class PixelEditAffiliateMethodsProviderTest
 */
class PixelEditAffiliateMethodsProviderTest extends TestCase
{
    ...
    public function testPixelEditShouldNotFailsWhenFiltersAreEmpty(): void
    {
        ...
        $affiliateMethodsProvider->pixelEdit(2, []);
    }
    ...
    public function testPixelEditWhenFiltersAreSet(): void
    {
        ...
        $affiliateMethodsProvider = new AffiliateMethodsProvider($transport);
        $affiliateMethodsProvider->pixelEdit(2, $filters);
    }
    ...
    public function testPixelEditResponse(): void
    {
        ...
        $affiliateMethodsProvider = new AffiliateMethodsProvider($transport);
        $response = $affiliateMethodsProvider->pixelEdit(2);
