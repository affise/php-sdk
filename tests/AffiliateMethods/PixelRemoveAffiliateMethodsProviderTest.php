...
/**
 * Class PixelRemoveAffiliateMethodsProviderTest
 */
class PixelRemoveAffiliateMethodsProviderTest extends TestCase
{
    ...
    public function testPixelRemoveResponse(): void
    {
        ...
        $response = $affiliateMethodsProvider->pixelRemove(2);
    ...
    public function testPixelRemoveFailsWhenTransportLayerThrowsException(string $exceptionClass): void
    {
        ...
        $affiliateMethodsProvider->pixelRemove(2);
    }
