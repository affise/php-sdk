...
/**
 * Class ByDeviceStatisticsProviderTest
 */
class ByDeviceStatisticsProviderTest extends TestCase
{
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByDeviceWhenFiltersAreSet(): void
    {
        ...
        $transport->expects($this->once())
            ->method('get')
            ->with('/3.0/stats/getbydevices', $filters)
            ->willThrowException(new RuntimeException());

        $this->expectException(RuntimeException::class);

        $statisticsProvider = new StatisticsProvider($transport);
        $statisticsProvider->byDevice($filters);
    }
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByDeviceFailsWhenFilterDateFromIsNotPassed(): void
    {
        $statisticsProvider = new StatisticsProvider($this->createStub(TransportInterface::class));
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByDeviceFailsWhenFilterDateToIsNotPassed(): void
    {
        $statisticsProvider = new StatisticsProvider($this->createStub(TransportInterface::class));
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByDeviceResponse(): void
    {
        $transport = $this->createMock(TransportInterface::class);
        ...
        $statisticsProvider = new StatisticsProvider($transport);
        $response = $statisticsProvider->byDevice(
            [
                'filter' => [
                    'date_from' => '2020-12-20',
                    'date_to' => '2020-12-20',
     ...
     */
    public function testByDeviceFailsWhenTransportLayerThrowsException(string $exceptionClass): void
    {
