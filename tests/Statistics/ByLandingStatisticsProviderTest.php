...
/**
 * Class ByLandingStatisticsProviderTest
 */
class ByLandingStatisticsProviderTest extends TestCase
{
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByLandingWhenFiltersAreSet(): void
    {
        ...
        $filters = [
            ...
            'filter' => [
                ...
                'affiliate_tag' => 'quo',
                'offer_tag' => 'laboriosam',
            ],
        ];

        $transport->expects($this->once())
            ->method('get')
            ->with('/3.0/stats/getbylanding', $filters)
            ->willThrowException(new RuntimeException());

        $this->expectException(RuntimeException::class);

        $statisticsProvider = new StatisticsProvider($transport);
        $statisticsProvider->byLanding($filters);
    }
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByLandingFailsWhenFilterDateFromIsNotPassed(): void
    {
        $statisticsProvider = new StatisticsProvider($this->createStub(TransportInterface::class));
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByLandingFailsWhenFilterDateToIsNotPassed(): void
    {
        $statisticsProvider = new StatisticsProvider($this->createStub(TransportInterface::class));
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByLandingResponse(): void
    {
        $transport = $this->createMock(TransportInterface::class);
        ...
        $statisticsProvider = new StatisticsProvider($transport);
        $response = $statisticsProvider->byLanding(
            [
                'filter' => [
                    'date_from' => '2020-12-20',
                    'date_to' => '2020-12-20',
     ...
     */
    public function testByLandingFailsWhenTransportLayerThrowsException(string $exceptionClass): void
    {
