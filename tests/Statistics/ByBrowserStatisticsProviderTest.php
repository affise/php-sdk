...
/**
 * Class ByBrowserStatisticsProviderTest
 */
class ByBrowserStatisticsProviderTest extends TestCase
{
    ...
    public static function setupBeforeClass(): void
    {
        static::$attributes = [
            [
                'slice' => ['browser' => 'Facebook for Android'],
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByBrowserWhenFiltersAreSet(): void
    {
        ...
        $transport->expects($this->once())
            ->method('get')
            ->with('/3.0/stats/getbybrowsers', $filters)
            ->willThrowException(new RuntimeException());

        $this->expectException(RuntimeException::class);

        $statisticsProvider = new StatisticsProvider($transport);
        $statisticsProvider->byBrowser($filters);
    }
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByBrowserFailsWhenFilterDateFromIsNotPassed(): void
    {
        $statisticsProvider = new StatisticsProvider($this->createStub(TransportInterface::class));
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByBrowserFailsWhenFilterDateToIsNotPassed(): void
    {
        $statisticsProvider = new StatisticsProvider($this->createStub(TransportInterface::class));
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByBrowserResponse(): void
    {
        $transport = $this->createMock(TransportInterface::class);
        ...
        $statisticsProvider = new StatisticsProvider($transport);
        $response = $statisticsProvider->byBrowser(
            [
                'filter' => [
                    'date_from' => '2020-12-20',
                    'date_to' => '2020-12-20',
     ...
     */
    public function testByBrowserFailsWhenTransportLayerThrowsException(string $exceptionClass): void
    {
