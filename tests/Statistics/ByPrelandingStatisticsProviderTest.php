...
/**
 * Class ByPrelandingStatisticsProviderTest
 */
class ByPrelandingStatisticsProviderTest extends TestCase
{
     ...
     */
    public function testByPrelandingFailsWhenFiltersAreNotSet(): void
    {
        $statisticsProvider = new StatisticsProvider($this->createStub(TransportInterface::class));

        $this->expectException(InvalidArgumentException::class);

        $statisticsProvider->byPrelanding([]);
    }
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByPrelandingWhenFiltersAreSet(): void
    {
        ...
        $transport->expects($this->once())
            ->method('get')
            ->with('/3.0/stats/getbyprelanding', $filters)
            ->willThrowException(new RuntimeException());

        $this->expectException(RuntimeException::class);

        $statisticsProvider = new StatisticsProvider($transport);
        $statisticsProvider->byPrelanding($filters);
    }
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByPrelandingFailsWhenFilterDateFromIsNotPassed(): void
    {
        $statisticsProvider = new StatisticsProvider($this->createStub(TransportInterface::class));
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByPrelandingFailsWhenFilterDateToIsNotPassed(): void
    {
        $statisticsProvider = new StatisticsProvider($this->createStub(TransportInterface::class));
     ...
     * @throws \Affise\Sdk\Exception\TransportException
     */
    public function testByPrelandingResponse(): void
    {
        $transport = $this->createMock(TransportInterface::class);
        ...
        $transport->expects($this->once())
            ->method('get')
            ->with('/3.0/stats/getbyprelanding')
            ->willReturn(
                [
                    'status' => 1,
                    'stats' => $attributes,
        ...
        $statisticsProvider = new StatisticsProvider($transport);
        $response = $statisticsProvider->byPrelanding(
            [
                'filter' => [
                    'date_from' => '2020-12-20',
                    'date_to' => '2020-12-20',
     ...
     */
    public function testByPrelandingFailsWhenTransportLayerThrowsException(string $exceptionClass): void
    {
