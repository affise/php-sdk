...
class AddOfferDto
{
    ...
    */
    ...
    private string $noteAff;
    private string $noteSales;
    ...
    */
    ...
    public function __construct(array $attributes)
    {
        ...
        $this->noteAff = $attributes['note_aff'];
        $this->noteSales = $attributes['note_sales'];
    ...
    */
    ...
    public function getNoteAff(): string
    {
        return $this->noteAff;
    }

    public function getNoteSales(): string
    {
